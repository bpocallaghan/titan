                    ...
                    <form id="form-edit" method="post" action="{{ $selectedNavigation->url . (isset($item)? '/' . $item->id : '') }}">
                        ...
                        <fieldset>
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    <section class="form-group {{ form_error_class('province_id', $errors) }}">
                                        <label for="province_id">Province / State</label>
                                        {!! form_select('province_id', ([0 => 'Please select a Province / State'] + $provinces), ($errors && $errors->any()? old('province_id') : (isset($item)? $item->province_id : '')), ['class' => 'select2 form-control']) !!}
